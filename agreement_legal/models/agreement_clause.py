...
class AgreementClause(models.Model):
    ...
    temp_agreement_id = fields.Many2one("agreement", string="Temp Agreement", help="This field help to filter section.")
    section_id = fields.Many2one("agreement.section", string="Section", ondelete="cascade")
    ...
    def _compute_dynamic_content(self):
        ...
        for clause in self:
            lang = clause.agreement_id and clause.agreement_id.partner_id.lang or "en_US"
