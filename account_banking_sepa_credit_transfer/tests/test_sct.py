...
class TestSCT(AccountTestInvoicingCommon):
    ...
    def setUpClass(cls):
        ...
        cls.main_company.partner_id.write(
            {
                "country_id": cls.env["res.country"].search([("code", "=", "NL")], limit=1).id,
                "city": "Amersfoort",
                "zip": "3865 CC",
        ...
        cls.partner_bank = cls.env["res.partner.bank"].create(
            {
                "account_number": "ES52 0182 2782 5688 3882 1868",
                "bank_id": cls.bank.id,
        ...
        cls.partner_bank_1 = cls.env["res.partner.bank"].create(
            {
                "account_number": "FR66 1212 1212 1212 1212 1212 121",
                "bank_id": cls.bank.id,
        ...
        cls.partner_bank_2 = cls.env["res.partner.bank"].create(
            {
                "account_number": "BE96 9988 7766 5544",
        ...
        cls.payment_mode = cls.env["account.payment.mode"].create(
            {
                ...
                "company_id": cls.main_company.id,
                "payment_method_id": cls.env.ref("account_banking_sepa_credit_transfer.sepa_credit_transfer").id,
    ...
    def check_eur_currency_sct(self):
        ...
        self.assertEqual(
            ...
            self.payment_order.company_partner_bank_id.sanitized_account_number,
        )
