...
class TestSaleOrder(CommonTestCase):
    ...
    def create_sale_order(self, payment_mode=None):
        ...
        sale = sale_form.save()
        self.assertEqual(sale.payment_mode_id, self.base_partner.customer_payment_mode_id)
        sale_form = Form(sale)
    ...
    def create_invoice_and_check(self, order, expected_payment_mode, expected_partner_bank):
