...
class TestL10nEsAeat(BaseCommon):
    ...
    def test_unique_date_range(self):
        self.env["l10n.es.aeat.map.tax"].create({"date_from": "2020-01-01", "date_to": "2020-12-31", "model": 303})
    ...
    def test_has_valid_aeat_identification(self):
        ...
        self.assertTrue(partner_with_aeat_identification._has_valid_aeat_identification())
        self.assertFalse(
            partner_with_aeat_identification._has_valid_aeat_identification(allow_alternative_identification=False)
        )
        ...
        self.assertFalse(partner_without_identification._has_valid_aeat_identification())
        ...
        self.assertFalse(partner_only_aeat_identification._has_valid_aeat_identification())
