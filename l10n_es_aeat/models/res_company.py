...
class ResCompany(models.Model):
    ...
    def create(self, vals_list):
        ...
        models = self.env["ir.model"].sudo().search([Domain("model", "=like", "l10n.es.aeat.%.report")])
        for model in models:
            try:
            ...
            .search(
                Domain.AND(
                    [
                        ...
                        Domain("module", "=", "account"),  # All is registered under this module
    ...
    def _get_taxes_from_xmlids(self, xmlids):
        ...
        """
        self.ensure_one()
        tax_ids = {self._get_tax_id_from_xmlid(x) for x in xmlids}
