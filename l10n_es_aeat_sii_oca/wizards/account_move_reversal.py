...
class AccountMoveReversal(models.TransientModel):
    ...
    def _selection_sii_refund_type(self):
        return self.env["account.move"].fields_get(allfields=["sii_refund_type"])["sii_refund_type"]["selection"]
    ...
    def default_get(self, fields_list):
        ...
        if "sii_refund_type" in fields_list or "sii_refund_type_required" in fields_list:
            ...
            supplier_invoices = to_refund.filtered(lambda x: x.move_type == "in_invoice")
