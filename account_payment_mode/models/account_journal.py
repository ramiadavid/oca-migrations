...
class AccountJournal(models.Model):
    ...
    def _default_outbound_payment_methods(self):
        all_out = self.env["account.payment.method"].search([("payment_type", "=", "outbound")])
        return all_out
    ...
    def _default_inbound_payment_methods(self):
        ...
        unique_codes = tuple(code for code, info in method_info.items() if info.get("mode") in allowed_modes)
