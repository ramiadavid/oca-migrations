...
class TestMisReportInstanceAnnotation(TransactionCase):
    ...
    def test_adding_note(self):
        ...
        notes = self.report_instance.get_notes_by_cell_id()
        self.assertDictEqual({first_cell_id: {"text": "This is a note", "sequence": 1}}, notes)
    ...
    def test_remove_note(self):
        ...
        # remove note
        self.env["mis.report.instance.annotation"].remove_annotation(first_cell_id, self.report_instance.id)
        notes = self.report_instance.get_notes_by_cell_id()
        self.assertEqual({}, notes)
