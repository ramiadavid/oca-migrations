...
export class MisReportWidget extends Component {
    ...
    get context() {
        return {
            ...
            ...(this.showPivotDate && this.state.pivot_date && {mis_pivot_date: this.state.pivot_date}),
        };
    }
    ...
    async _remove_annotation(cell_id) {
        await this.orm.call("mis.report.instance.annotation", "remove_annotation", [cell_id, this._instanceId()], {
            context: this.context,
        });
    ...
    async _save_annotation(cell_id, text) {
        await this.orm.call("mis.report.instance.annotation", "set_annotation", [cell_id, this._instanceId(), text], {
            context: this.context,
        });
        await this.refresh_annotation();
    }
    ...
    async resize_sheet() {
        ...
        sheet_element.classList.toggle("oe_mis_builder_report_wide_sheet", this.wide_display);
