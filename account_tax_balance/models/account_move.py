...
class AccountMove(models.Model):
    ...
    def _compute_financial_type(self):
        def _balance_get(line_ids, account_type):
            return sum(line_ids.filtered(lambda x: x.account_id.account_type == account_type).mapped("balance"))
        ...
        for move in self:
            ...
            if "asset_cash" in account_types or "liability_credit_card" in account_types:
