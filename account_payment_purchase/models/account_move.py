...
class AccountMove(models.Model):
    ...
    def _onchange_purchase_auto_complete(self):
        ...
        if purchase_id:
            new_invoice_vals = purchase_id.with_company(purchase_id.company_id)._prepare_invoice()
        ...
        if old_mode and new_mode and old_mode != new_mode:
            res["warning"] = {
                ...
                "message": self.env._("Selected purchase order have different payment mode."),
            }
            return res
        ...
        if old_bank and new_bank and old_bank != new_bank:
            res["warning"] = {
                "title": self.env._("Warning"),
                "message": self.env._("Selected purchase order have different supplier bank."),
            }
