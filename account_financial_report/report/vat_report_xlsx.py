...
class VATReportXslx(models.AbstractModel):
    ...
    def _get_report_filters(self, report):
        return [
            ...
            [
                self.env._("Based on"),
                self.env._("Tax Tags") if report.based_on == "taxtags" else self.env._("Tax Groups"),
            ],
        ]
    ...
    def _generate_report_content(self, workbook, report, data, report_data):
        res_data = self.env["report.account_financial_report.vat_report"]._get_report_values(report, data)
