...
class TestVATReport(AccountTestInvoicingCommon):
    ...
    def setUpClass(cls):
        ...
        cls.tax_group_10 = cls.env["account.tax.group"].create({"name": "Tax 10%", "sequence": 1})
        cls.tax_group_20 = cls.env["account.tax.group"].create({"name": "Tax 20%", "sequence": 2})
    ...
    def _get_report_lines(self, taxgroups=False):
        ...
        res_data = self.env["report.account_financial_report.vat_report"]._get_report_values(vat_report, data)
        return res_data
