...
class TestTrialBalanceReport(AccountTestInvoicingCommon):
    ...
    def setUpClass(cls):
        ...
        # 20.0: account.group desaparece; los grupos son cuentas padre
        cls.group1 = cls._create_account_account(cls, {"code": "1", "name": "Group 1", "account_type": "asset_current"})
        ...
        cls.group2 = cls._create_account_account(
            cls, {"code": "2", "name": "Group 2", "account_type": "liability_current"}
        )
        # Set accounts
        ...
        cls.foreign_currency = cls.setup_other_currency("EUR", rates=[("1900-01-01", 2.0)])
    ...
    def _get_report_lines(
        ...
        res_data = self.env["report.account_financial_report.trial_balance"]._get_report_values(trial_balance, data)
        return res_data
    ...
    def test_03_partner_balance(self):
        ...
        check_partner_receivable = self.check_partner_in_report(self.account100.id, self.partner.id, total_amount)
    ...
    def test_04_undistributed_pl(self):
        ...
        check_unaffected_account = self.check_account_in_report(self.unaffected_account.id, trial_balance)
    ...
    def test_05_all_accounts_loaded(self):
        ...
        [trial_balance_code_set.add(account.code) for account in trial_balance.account_ids]
    ...
    def test_07_foreign_currency_initial_balance(self):
        ...
        account_lines = self._get_account_lines(self.account100.id, res_data["trial_balance"])
