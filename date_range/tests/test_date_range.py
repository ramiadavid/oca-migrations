...
class DateRangeTest(TransactionCase):
    def setUp(self):
        ...
        self.company_2 = self.env["res.company"].create({"name": "Test company 2", "parent_id": self.company.id})
    ...
    def test_invalid(self):
        ...
        self.assertEqual(message, "FS2016 is not a valid range (2016-12-31 > 2015-01-01)")
