...
class L10nEsVatBook(models.Model):
    ...
    def _compute_error_count(self):
        ...
        vat_book_exception_dict = {vat_book_id.id: count for vat_book_id, count in vat_book_exception_group}
    ...
    def _prepare_vat_book_tax_summary(self, tax_lines, book_type):
        ...
        for tax_line in tax_lines:
            ...
            tax_summary_data_recs[tax_line.tax_id]["base_move_line_ids"] += tax_line.base_move_line_ids.ids
            tax_summary_data_recs[tax_line.tax_id]["move_line_ids"] += tax_line.move_line_ids.ids
        ...
        for rec in self:
            ...
            for book_type in ["issued", "received"]:
                ...
                lines = moves.filtered(
                    ...
                    or (line.tax_line_id in taxes and accounts.get(line.tax_line_id) != line.account_id)
                )
                if map_lines:
