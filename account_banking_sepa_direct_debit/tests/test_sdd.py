...
class TestSDDBase(TransactionCase):
        ...
        cls.mandate12 = cls.env["account.banking.mandate"].create(
            {
                ...
                "signature_date": fields.Date.to_string(fields.Date.today().replace(month=1, day=1)),
        ...
        cls.mandate2 = cls.env["account.banking.mandate"].create(
            {
                ...
                "type": "recurrent",
                "recurrent_sequence_type": "first",
                "signature_date": fields.Date.to_string(fields.Date.today().replace(day=1)),
    ...
    def check_sdd(self):
        ...
        self.assertEqual(
            ...
            payment_order.company_partner_bank_id.sanitized_account_number,
        )
