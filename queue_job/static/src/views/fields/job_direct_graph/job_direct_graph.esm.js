...
const {Component, onWillStart, useLayoutEffect, useRef} = owl;
...
class JobDirectGraph extends Component {
    ...
    renderNetwork() {
        ...
        if (nodes.length * edges.length > 5000 && !this.forceRender) {
            ...
            warningDiv.className += " flex-column justify-content-center align-items-center";
    ...
    async openDependencyJob(resId) {
        const action = await this.orm.call(this.model, "get_formview_action", [[resId]], {
