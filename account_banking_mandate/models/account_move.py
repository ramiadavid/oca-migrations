...
class AccountMove(models.Model):
    ...
    mandate_required = fields.Boolean(related="payment_mode_id.payment_method_id.mandate_required", readonly=True)
    ...
    def partner_banks_to_show(self):
        ...
        if not res and self.payment_mode_id.payment_method_id.code == "sepa_direct_debit":  # pragma: no cover
            return self.mandate_id.partner_bank_id or self.partner_id.valid_mandate_id.partner_bank_id
        return res
