...
class ResPartner(models.Model):
    ...
    mandate_count = fields.Integer(compute="_compute_mandate_count", string="Number of Mandates", readonly=True)
    ...
    def _compute_mandate_count(self):
        ...
        res = mandate_model._read_group(domain=domain, groupby=["partner_id"], aggregates=["__count"])
    ...
    def _compute_valid_mandate_id(self):
        ...
        for partner in self:
            ...
            if commercial_partner.id in mandates_dic:
                ...
                mandates = partner.commercial_partner_id.bank_ids.mapped("mandate_ids").filtered(
