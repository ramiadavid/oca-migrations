...
class TestSaleOrderLinePriceHistory(TransactionCase):
    ...
    def setUpClass(cls):
        ...
        cls.sale_order_1 = cls.env["sale.order"].create({"partner_id": cls.partner_1.id})
        ...
        cls.sale_order_2 = cls.env["sale.order"].create({"partner_id": cls.partner_2.id})
        ...
        cls.sale_order_3 = cls.env["sale.order"].create({"partner_id": cls.partner_2.id})
    ...
    def test_onchange_partner_id_include_quotations(self):
        ...
        self.sale_order_4 = self.env["sale.order"].create({"partner_id": self.partner_2.id})
    ...
    def test_onchange_partner_id_include_commercial_partner(self):
        ...
        self.sale_order_4 = self.env["sale.order"].create({"partner_id": child_partner.id})
        self.sale_order_line_4 = self.env["sale.order.line"].create(
            {
                "order_id": self.sale_order_4.id,
                "name": self.product.name,
