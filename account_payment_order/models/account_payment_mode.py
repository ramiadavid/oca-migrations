...
class AccountPaymentMode(models.Model):
    ...
    payment_order_ok = fields.Boolean(string="Selectable in Payment Orders", default=True)
    ...
    default_invoice = fields.Boolean(string="Linked to an Invoice or Refund", default=False)
