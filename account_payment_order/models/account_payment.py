...
class AccountPayment(models.Model):
    ...
    order_state = fields.Selection(related="payment_order_id.state", string="Payment Order State")
    ...
    def update_payment_reference(self):
        ...
        return {
            ...
            "context": dict(self.env.context, default_payment_reference=self.payment_reference),
        }
