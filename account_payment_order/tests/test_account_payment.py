...
class TestAccountPayment(AccountTestInvoicingCommon):
    ...
    def test_account_payment_03(self):
        ...
        payment_methods = (
            new_account_payment.inbound_payment_method_line_ids.payment_method_id.ids
        )
        ...
        # check payment methods
        payment_methods = (
            new_account_payment.outbound_payment_method_line_ids.payment_method_id.ids
        )
        ...
        # check payment methods
        payment_methods = (
            new_account_payment.available_payment_method_line_ids.payment_method_id.ids
        )
        self.assertNotIn(self.inbound_payment_method_01.id, payment_methods)
