...
class TestL10nEsAeatMod347(TestL10nEsAeatModBase):
    ...
    def setUpClass(cls):
        ...
        cls.customer_3 = cls.customer.copy({"name": "Test customer 3", "vat": "12345678Z"})
    ...
    def test_mod347_unit_partner_record(self):
        ...
        self.assertTrue(any(r.get("partner_id") == partner_record.partner_id.id for r in recipients))
        ...
        self._invoice_purchase_create("2019-01-01", {"partner_id": partner_record.partner_id.id})
